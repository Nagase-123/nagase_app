...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                <a class="navbar-brand" href="#!"><i class="bi bi-scissors m-auto text-primary"></i>Chouette
        ...
        <section class="showcase">
            ...
            <div class="container-fluid p-0">
                <div class="row g-0" id="consept">
                  <!--元の  <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('assets/img/bg-showcase-1.jpg')"></div>-->
                  <!--imgに変えてみる-->
                    <img class="col-lg-6 order-lg-2 text-white showcase-img img-opacity animation2" src="{{ asset('assets/img/bg-showcase-1.jpg') }}">
                ...
                <div class="row g-0" id="biginner">
                    <img class="col-lg-6 text-white showcase-img img-opacity animation2" src="{{ asset('assets/img/bg-showcase-2.jpg') }}">
                ...
                <div class="row g-0" id="menue">
                    <img class="col-lg-6 order-lg-2 text-white showcase-img img-opacity animation2" src="{{ asset('assets/img/bg-showcase-3.jpg') }}">
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text animation">
        ...
        <!-- Testimonials-->
        <section class="testimonials text-center bg-light animation2" id="staff">
            <div class="container">
        ...
        <!-- Call to Action-->
        <section class="call-to-action text-white text-center animation2" id="signup">
            <div class="container position-relative">
                <div class="row justify-content-center">
                    <div class="col-xl-6">
